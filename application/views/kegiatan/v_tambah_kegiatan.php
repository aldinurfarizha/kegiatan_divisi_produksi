  ...
  <div class="row">
   ...
   <div class="input-group col-lg-12">
    <div class="input-group-addon">
       ...
       <input type="text" placeholder="Misal: Koordinasi terkait..." class="form-control" name="kegiatan" autocomplete="off" required>
   </div>
   ...
   <div class="input-group col-lg-12">
    <div class="input-group-addon">
       ...
       <input type="date" class="form-control" name="waktu_kegiatan" autocomplete="off" required>
   </div>
   ...
   <div class="input-group col-lg-12">
    <div class="input-group-addon">
       ...
       <input type="text" class="form-control" name="output" autocomplete="off" required>
   </div>
    <br>
                        </div>
                </div>
...
<label>Uraian Kegiatan</label>
    <div class="input-group col-lg-12">
    <textarea class="form-control" rows="3" name="uraian_kegiatan[]" placeholder="Misal: Koordinasi Terkait jalur pipa..."></textarea>
    </div>
<label>Kendala</label>
    <div class="input-group col-lg-12">
  ...
  <div class="input-group">
     ...
     <input type="text" name="penanggung_jawab[]" class="form-control" placeholder="Misal:Kepala Divisi Produksi" required>
    </div>
</div>
<div class="col-sm-6">
    <div class="input-group">
