  ...
  <div class="row">
   ...
   <div class="input-group col-lg-12">
    <div class="input-group-addon">
       ...
       <input type="date" class="form-control" name="waktu_kegiatan2" id="waktu_kegiatan" autocomplete="off">
   </div>
...
<script>  
 $(document).ready(function(){  
  ...
  $('#loading').hide();
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<div id="row'+i+'" class="box box-info"><div class="box-header with-border"><div class="row"><div class="col-md-3"><h3 class="box-title">('+i+') Deskripsi Kegiatan</h3></div><div class="col-md-3 pull-right"><p align="right"><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></p></div></div></div><div class="box-body"><label>Uraian Kegiatan</label><div class="input-group col-lg-12"><textarea class="form-control" name="uraian_kegiatan[]" rows="3" placeholder="Misal: Koordinasi Terkait jalur pipa..."></textarea></div><label>Kendala</label><div class="input-group col-lg-12"><input type="text" class="form-control" name="kendala[]" value="-" required></div><label>Tindak Lanjut Yang di Perlukan</label><div class="input-group col-lg-12"><input type="text" class="form-control" name="tindak_lanjut[]" value="-" required></div><label>Indikator Hasil Utama</label><div class="input-group col-lg-12"><select name="indikator[]" class="form-control" required><option value="100%">100%</option><option value="90%">90%</option><option value="80%">80%</option><option value="70%">70%</option><option value="60%">60%</option><option value="50%">50%</option><option value="40%">40%</option><option value="30%">30%</option><option value="20%">20%</option><option value="10%">10%</option><option value="0%">0%</option></select></div><label>Penanggung Jawab</label> <div class="row"><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">1.</div><select name="penanggung_jawab[]" id="tahun" class="form-control" required><option selected="true" disabled="disabled">-- Pilih Penanggung Jawab --</option>  <option value="Kepala Divisi Produksi">Kepala Divisi Produksi</><option value="Kasub.Div Kualitas Air">Kasub.Div Kualitas Air</option><option value="Kasub.Div Pengendalian Air Baku">Kasub.Div Pengendalian Air Baku</option><option value="Kasub.Div Pengadaan">Kasub.Div Pengadaan</option><option value="Kepala Divisi Trandist">Kepala Divisi Trandis</option><option value="Kepala Divisi Umum">Kepala Divisi Umum</option><option value="Kepala Divisi Litbang">Kepala Divisi Litbang</option></select></div></div><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">2.</div> <select name="penanggung_jawab2[]" id="tahun" class="form-control"><option selected="true" disabled="disabled">-- Pilih Penanggung Jawab --</option>  <option value="Kepala Divisi Produksi">Kepala Divisi Produksi</><option value="Kasub.Div Kualitas Air">Kasub.Div Kualitas Air</option><option value="Kasub.Div Pengendalian Air Baku">Kasub.Div Pengendalian Air Baku</option><option value="Kasub.Div Pengadaan">Kasub.Div Pengadaan</option><option value="Kepala Divisi Trandist">Kepala Divisi Trandis</option><option value="Kepala Divisi Umum">Kepala Divisi Umum</option><option value="Kepala Divisi Litbang">Kepala Divisi Litbang</option></select></div></div></div><br><div class="row"><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">3.</div><select name="penanggung_jawab3[]" id="tahun" class="form-control"><option selected="true" disabled="disabled">-- Pilih Penanggung Jawab --</option><option value="Kepala Divisi Produksi">Kepala Divisi Produksi</><option value="Kasub.Div Kualitas Air">Kasub.Div Kualitas Air</option><option value="Kasub.Div Pengendalian Air Baku">Kasub.Div Pengendalian Air Baku</option><option value="Kasub.Div Pengadaan">Kasub.Div Pengadaan</option><option value="Kepala Divisi Trandist">Kepala Divisi Trandis</option><option value="Kepala Divisi Umum">Kepala Divisi Umum</option><option value="Kepala Divisi Litbang">Kepala Divisi Litbang</option></select></div></div><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">4.</div><select name="penanggung_jawab4[]" id="tahun" class="form-control"><option selected="true" disabled="disabled">-- Pilih Penanggung Jawab --</option><option value="Kepala Divisi Produksi">Kepala Divisi Produksi</><option value="Kasub.Div Kualitas Air">Kasub.Div Kualitas Air</option><option value="Kasub.Div Pengendalian Air Baku">Kasub.Div Pengendalian Air Baku</option><option value="Kasub.Div Pengadaan">Kasub.Div Pengadaan</option><option value="Kepala Divisi Trandist">Kepala Divisi Trandis</option><option value="Kepala Divisi Umum">Kepala Divisi Umum</option><option value="Kepala Divisi Litbang">Kepala Divisi Litbang</option></select></div></div></div><br><div class="row"><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">5.</div><input type="text" name="penanggung_jawab5[]" class="form-control" placeholder="Misal:Kepala Divisi Produksi"></div></div><div class="col-sm-6"><div class="input-group"><div class="input-group-addon">6.</div><input type="text" name="penanggung_jawab6[]" class="form-control" placeholder="Misal:Kasubdiv Kualitas Air"></div></div></div><label>Keterangan</label><div class="input-group col-lg-12"><input type="text" class="form-control" name="keterangan[]" value="-" required></div></div></div></div>');  
      });  
