...
<div class="wrapper">
  ...
  <strong>Sukses !</strong> Penambahan Data perbaikan Berhasil
</div> 
<?php endif; ?>
          ...
          <div class="col-md-6">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-wrench"></i> Tambah perbaikan</h3>
              </div>
              <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url().'aset/simpan_perbaikan' ?>">
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Awal perbaikan</label>
                    <div class="col-sm-10">
                    <div class="input-group">
...
<div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Akhir perbaikan</label>
                    <div class="col-sm-10">
                    <div class="input-group">
...
<div class="form-group">
                  ...
                  <div id="pilihan_metode" class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Status perbaikan</label>
                    <div class="col-sm-10">
                      <div class="input-group">
      ...
      &nbsp;
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-camera"></i> Dokumentasi Kegiatan perbaikan</h3>
              </div>
