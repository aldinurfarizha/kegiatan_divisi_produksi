...
<?php 
              ...
              ?>
               <div id="hapus<?php echo $id_hasil?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'test/hapus_hasil_test_param'?>">
...
<div class="modal fade" id="editpelanggan<?php echo $id_hasil;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url().'test/edit_hasil_test_param'; ?>">
      <div class="modal-body">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form autocomplete="off" method="post" action="<?php echo base_url().'test/tambah_hasil_test_param'; ?>">
		<div class="form-group">
    
		<label><i class="fa fa-calendar"></i> Bulan</label>
    <div class="input-group col-lg-6">
    <select name="bulan" id="bulan" class="form-control" required>
    <option selected value="<?php echo $no_bulan?>"> <?php echo $bulan?> </option>
