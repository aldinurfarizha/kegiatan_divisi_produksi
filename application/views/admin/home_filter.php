...
<strong> Data yang di tampilkan merupakan Data Bulan <?php echo $nama_bulan;?> Tahun <?php echo $tahun;?> </strong>
</div> 
<input type="button" class="btn-lg btn-success" value="Cetak" onClick="window.print()">
<br>
<br>
      <div class="row">
    ...
    <center><h1 class="box-title"><i class="fa fa-calendar-check-o"></i> Data Bulan <?php echo $nama_bulan;?> Tahun <?php echo $tahun;?> </h1></center>
...
<td class="count"><?php echo $no;?></td>
  ...
  <td class="keterangan"><?php echo $keterangan;?></td>
...
<script>
		...
		var myChart = new Chart(ctx, {
          ...
          <?php endforeach?>
				...
				datasets: [{
					label: 'Total Percentage Dari Setiap Lokasi',
					data: [<?php foreach ($grafik-> result_array() as $sws):
              $total_perbaikan_zona=$sws['persentase'];?>
